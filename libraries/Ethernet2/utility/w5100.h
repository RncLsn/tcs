...
#define IINCHIP_RxMAX 0x800
#define IINCHIP_TxMAX 0x800
#define IINCHIP_RxMASK 0x7FF
#define IINCHIP_TxMASK 0x7FF

#define setGAR(addr) wiz_write_buf(GAR0,addr,4)
#define getGWIP(addr) wiz_read_buf(GAR0,addr,4)
#define setSUBR(addr) wiz_write_buf(SUBR0,addr,4)
#define setSHAR(addr) wiz_write_buf(SHAR0,addr,6)
#define setSIPR(addr) wiz_write_buf(SIPR0,addr,4)
#define getIR() wiz_read_byte(IR)
#define setMR(val) wiz_write_byte(MR,val)
#define setRTR(timeout) wiz_write_word(RTR0,timeout)
#define setRCR(retry) wiz_write_byte(RCR,retry)
#define setIMR(mask) wiz_write_byte(IMR,mask)
#define getGAR(addr) wiz_read_buf(GAR0,addr,4)
#define getSUBR(addr) wiz_read_buf(SUBR0,addr,4)
#define getSHAR(addr) wiz_read_buf(SHAR0,addr,6)
#define getSIPR(addr) wiz_read_buf(SIPR0,addr,4)
#define getSn_DHAR(s, addr) wiz_read_buf(Sn_DHAR0(s),addr,6)
#define setSn_DHAR(s, addr) wiz_write_buf(Sn_DHAR0(s),addr,6)
#define getSn_DIPR(s, addr) wiz_read_buf(Sn_DIPR0(s),addr,6)
#define setSn_DIPR(s, addr) wiz_write_buf(Sn_DIPR0(s),addr,6)
#define getSn_DPORT(s, addr) wiz_read_buf(Sn_DPORT0(s),addr,2)
#define setSn_DPORT(s, addr) wiz_write_buf(Sn_DPORT0(s),addr,2)
#define setSn_MSS(s, Sn_MSSR0) wiz_write_word(Sn_MSSR0(s),Sn_MSSR0)
#define setSn_TTL(s, ttl) wiz_write_byte(Sn_TTL(s), ttl)
#define setSn_PROTO(s, proto) wiz_write_byte(Sn_PROTO(s),proto)
#define getSn_IR(s) wiz_read_byte(Sn_IR(s))
#define getSn_SR(s) wiz_read_byte(Sn_SR(s))


/*********************************************************
* iinchip access function
*********************************************************/
extern uint8 wiz_read_byte(uint16 addr);
extern uint16 wiz_read_word(uint16 addr);

extern void wiz_write_byte(uint16 addr,uint8 data);
extern void wiz_write_word(uint16 addr, uint16 data);

extern void wiz_read_buf(uint16 addr, uint8* buf,uint16 len);
extern void wiz_write_buf(uint16 addr,uint8* buf,uint16 len);

extern void iinchip_init(void); // reset iinchip
extern void sysinit(); // setting tx/rx buf size
